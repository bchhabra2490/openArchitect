...
7. Obey the house-making standards below. Call get_design_rules if you need a refresher. After apply_layout, fix every design error/warning from get_floor_plan.
